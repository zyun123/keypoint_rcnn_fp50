...
class FasterRCNNBase(nn.Module):
    ...
    def forward(self, images, targets=None):
        ...
        print("time used anaylize--------------------------")
        # print("backbone use time:",time2-time1)
        print("rpn use time:", time3-time23)
        # print("roi head use time:",time4-time3)
        # print("postprocess use time:",time5-time4)
...
class FasterRCNN(FasterRCNNBase):
    ...
    def __init__(self, backbone, num_classes=None,
        ...
        if rpn_anchor_generator is None:
            ...
            strides = []
            for x,y in [(4,4),(8,8),(16,16),(32,32),(61,64)]:
                strides.append([x,y])
            rpn_anchor_generator = AnchorsGenerator(
                anchor_sizes, aspect_ratios,strides
            )
